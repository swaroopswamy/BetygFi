...
export default function Dashboard() {
  return (
    <>
      {/* <Grid bg='#E8E8E8' >
        <GridItem colSpan={2} colStart={0} colEnd={2}w="100%">
          dic
        </GridItem>
        <GridItem colSpan={2} colStart={2} colEnd={4} w="100%">div</GridItem>
      </Grid> */}
    
    <Container >
     <Box width="1229px" height="264px" bg="#1a202c5e" sx={heading}>
      <Heading padding-left="30px">
        Terms and condition
      </Heading>
     </Box> 
        
     <Box width="898px" height="603">
    <Text color= "#191919" font-family= "Manrope" font-size="16px" font-style= "normal" font-weight= "400" line-height= "26px" >
