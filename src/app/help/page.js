"use client"
import {
  Box, Container, Text, Flex, Accordion, AccordionItem, AccordionButton,
  AccordionPanel, AccordionIcon, useColorModeValue, Icon, Image
              ...
              <>
                <h2>
                  <AccordionButton>
                    ...
                    {isExpanded ? <Image src={'/images/ellipse-dark-up.png'} w={"24px"} h={"24px"} /> : <Image src={'/images/ellipse-dark-down.png'} w={"24px"} h={"24px"} />}
                  </AccordionButton>
                </h2>
                <AccordionPanel pb={4}>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
