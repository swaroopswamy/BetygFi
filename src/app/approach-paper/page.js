      ...
      <Box width={"90%"} display={{ base: "block", md: "none" }}>
        ...
        >
          ...
          <Text padding={"10px 0px 0px 20px"} variant={"content"}>
            ...
            <br />
            <br />
            BetygFi is a comprehensive machine learning-based approach to assess
            DeFi protocols. The goal is to evolve a robust, real time, neutral,
            self-learning approach towards analyzing DeFi’s.
            <br />
            <br />
            The model underpinning Betygfi currently analyses technical risk,
            centralization risk, financial/market risk, and userbase quality
            risks. The model currently leverages a combination of supervised and
            unsupervised learning techniques to enable classification of DeFi
            protocols/projects.
          </Text>
        </Box>
        ...
        >
          ...
          <Text padding={"10px 0px 0px 20px"} variant={"content"}>
            ...
            sources/data sets, an efficient data pipeline, and dependable data
            normalization techniques. Solvendo, through its work in traditional
            finance understands the significance of a robust ETL (extraction,
          ...
          <Box padding={"29px 0px 0px 15px"}>
            ...
            <Box padding={"10px 0px 0px 45px"}>
              <ul>
                <li>
                  <Text variant={"content"}> Time on Mainnet</Text>
                </li>
                <li>
                  <Text variant={"content"}>
                    {" "}
                ...
                <li>
                  <Text variant={"content"}> Public Audit </Text>
                </li>
                <li>
                  <Text variant={"content"}> Recent Audit</Text>{" "}
                </li>
                <li>
                  <Text variant={"content"}> Open Source </Text>
                </li>
                <li>
                  <Text variant={"content"}> Byte Source code verified</Text>{" "}
                </li>
                <li>
                  {" "}
                  <Text variant={"content"}>Number of Engineers working </Text>
                </li>
                <li>
                  <Text variant={"content"}> Number of code commits</Text>{" "}
                </li>
                <li>
                  {" "}
                  <Text variant={"content"}>Bounty Program</Text>{" "}
                </li>
              </ul>
            </Box>
          </Box>
          ...
          <Box padding={"29px 0px 0px 15px"}>
            ...
            <Box padding={"10px 0px 0px 45px"}>
              <ul>
                ...
                <li>
                  {" "}
                  <Text variant={"content"}>Relative Strength Index (RSI)</Text>
                </li>
                <li>
                  {" "}
          ...
          <Box padding={"29px 0px 0px 15px"}>
            ...
            <Box padding={"10px 0px 0px 45px"}>
              <ul>
                ...
                <li>
                  {" "}
                  <Text variant={"content"}> Asset Liquidation Threshold</Text>
                </li>
              </ul>
            </Box>
          </Box>
