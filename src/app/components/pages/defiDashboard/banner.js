...
const Banner = () => {
    ...
    return (
        <>
            <Box display={{ base: "none", lg: "flex" }} justifyContent={"space-between"} w={"100%"} borderBottom={useColorModeValue("1px solid #BFBFBF", "1px solid #2F2F2F")} bgColor={useColorModeValue("#F0F0F5", "#191919")} >
            ...
            <Box display={{ base: "flex", lg: "none" }} flexDir={"column"} justifyContent={"space-between"} w={"100%"} gap={"15px"} borderBottom={useColorModeValue("1px solid #BFBFBF", "1px solid #2F2F2F")} bgColor={useColorModeValue("#FFFFFF", "#202020")} >
                <Box display={"flex"} flexDir={"column"} gap={"15px"}>
                    ...
                    <Box display={"flex"} w={"100%"} justifyContent={"left"} px={"15px"}>
                        <Text variant={'h3'} color={useColorModeValue("#3A3A3A", "#A8ADBD")}>
                            {defiData?.chains?.length ?? 0} chains
                        </Text>
                    </Box>
...
const ScoreBox = ( {score} ) => {
    return (
        <Box
            ...
            alignItems={"center"}
            position={"relative"}
            bgColor={{base: useColorModeValue("#F0F0F5", "#191919"), lg: useColorModeValue("#FFFFFF", "#202020")}}
            p={"10px"}
            gap={"10px"}
            h="fit-content"
            borderRadius={"6px"}
