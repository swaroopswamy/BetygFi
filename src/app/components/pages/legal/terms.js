                ...
                <Box
                    ...
                    padding={"35px 150px 70px 72px"}>
                        ...
                        <Text variant={"content"} paddingTop={"20px"} paddingLeft={"20px"}>
                            ...
                            <br />
                            <br />
                            These “Terms” and “Conditions of Use” (referred to as “Terms”) constitute an electronic record within the meaning of relevant laws, rules and regulations as may be applicable in India. The Terms are an electronic record  and  generated  by  a  computer  system;  it  does  not  require  any  physical  or  digital  signatures  for  its acceptance by You. By clicking on 'Agree' and/or by using BetygFi You are agreeing to and accept these Terms.
                            <br />
                            <br />
                            BetygFi reserves the right to stipulate Terms that might be in addition and/or in replacement to these Terms from time to time. We shall seek Your confirmation in such case, to enable Your use of the platform.
                            <br />
                            <br />
                            Our Privacy Policy is an important part of these Terms. It governs Your use of our Services and explains how we collect, use, safeguard and disclose information including information that results from Your use of our platforms. You will find a detailed Privacy Policy by
                            <br />
                            <br />
                            Your  agreement  with  us  includes  these  Terms  and  our  Privacy  Policy  (collectively  referred  to  as “Agreements”)
                            <br />
                            <br />
                            By clicking on “Agree” and/or by using BetygFi- You acknowledge that You have read and understood the Terms and Agreements (including the Privacy Policy).
                            <br />
                            <br />
                        ...
                        <Text variant={"content"} paddingTop={"10px"} paddingLeft={"75px"}>
                            ...
                            <br />
                            <br />
                            Account comprises of username, password and other user information.
                            <br />
                            <br />
                            ...
                            <br />
                            <br />
                            Data  Science  Engine is  the  capability  of  BetygFi,  by  itself  or  through  its  affiliates  and/or  assigns  to  use algorithms and technology, to extract and produce useful insights from raw data;
                            <br />
                            <br />
                            Device means any device that can access the Service, viz. a computer, a cellphone or a digital tablet.
                            <br />
                            <br />
                            Information means data, message, text, images, sound, voice, codes, computer programmes, software and data bases or micro film or computer generated micro fiche;
                            <br />
                            <br />
                            ...
                            <br />
                            <br />
                            Service(s) refers to the services provided by the BetygFi.
                            <br />
                            <br />
                            Terms and Conditions (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the BetygFi regarding the use of the Service. The Terms and Conditions also include the Privacy Policy, a link for which has been provided in these Terms and Conditions.
                            <br />
                            <br />
                            Third-party Social Media Service means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.
                            <br />
                            <br />
                            Platform refers to BetygFi, accessible from www.betygfi.com
                            <br />
                            <br />
                        ...
                        <Text variant={"content"} paddingTop={"20px"} paddingLeft={"20px"}>
                            ...
                            <br />
                            <br />
                            As a user You should make sure that You make all arrangements necessary for you to have access to BetygFi.
                            <br />
                            <br />
                            To access BetygFi or some of the resources it offers, you may be asked to provide certain registration details or other information. It is a condition of your use that all the information you provide on BetygFi is correct, current, and complete. You agree that all information you provide to use the services, including, but not limited to, using any interactive features on the websites, is governed by our privacy policy, and you consent to all actions we may take with respect to your information that are consistent with our privacy policy.
                            <br />
                            <br />
                        ...
                        <Text variant={"content"} paddingTop={"20px"} paddingLeft={"20px"}>
                            ...
                            <br />
                            <br />
                            Neither BetygFi nor any person associated with BetygFi makes any warranty or representation with respect to the completeness, security, reliability, quality, accuracy, or availability of the services, or the data, analysis, information, content, materials made available on BetygFi. Without limiting the foregoing, neither BetygFi nor anyone associated with BetygFi represents or warrants that the services, or the data, analysis, information, content, materials available on BetygFi is and/or will be accurate, reliable, error-free, or uninterrupted, that defects will be corrected, that the services or the server that makes it available are free of viruses or other harmful components or that the services or any services or items obtained through the services will otherwise meet your needs or expectations.
                            <br />
                            <br />
                            BetygFi hereby disclaims all warranties of any kind, whether express or implied, statutory, or otherwise, including but not limited to any warranties of quality, accuracy, merchantability, non-infringement, and fitness for particular purpose.
                            <br />
                            <br />
                        ...
                        <Text variant={"content"} paddingTop={"20px"} paddingLeft={"20px"}>
                            ...
                            <br />
                            <br />
                            BetygFi has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or Services. You further acknowledge and agree that BetygFi shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods or Services available on or through any such web sites or Services.
                            <br />
                            <br />
...
export default TermsPanelComponent;
