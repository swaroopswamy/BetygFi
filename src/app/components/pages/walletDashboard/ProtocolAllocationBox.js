                    ...
                    <Flex>
                      ...
                      <>
                        <Image
                          ...
                          src={
                            colorMode === "light"
                              ? "/images/Definame(light).svg"
                              : "/images/Definame(black).svg"
                          }
                        ></Image>
                      </>
                    </Flex>
              ...
              >
                ...
                {protocolAllocationData?.isSuccess &&
                  (Object.keys(protocolAllocationData?.data)?.length > 0 ? (
                    Object.keys(protocolAllocationData?.data)?.map(
                      (item, i) => {
                        return (
                          <TableRow
                            key={i}
...
const TableRow = ({ i, logoUrl, name, percentage, value }) => {
  return (
    <>
      <Tr height={"40px"} key={i} display={{ base: "none", md: "table-row" }}>
        <Td _dark={{ color: "#FFFFFF" }} _light={{ color: "#16171B" }}>
          <Box display={"flex"} alignItems={"center"}>
            <>
              <Image width={5} height={5} alt="logo" src={logoUrl}></Image>
            </>
        ...
        <Td fontSize={"14px"}>USD {USDollar.format(value)}</Td>
      </Tr>
