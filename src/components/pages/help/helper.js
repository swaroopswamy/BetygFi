...
export const General = [
	{
		...
		content: "Data shown on the BetygFi is the blend of onchian and offchian data.",
		point1: "Onchain data is available within seconds of block finalization.",
		point2: "Offchain data is available as per the 3rd party updation."
	},
	{
...
export const WalletsAndDeFiDashboard = [
	...
	},
	{
		...
		content: "By searching any user’s DeFi wallet, you can find various information such as:",
		point1: "The wallet address, which is a unique identifier that represents the user’s wallet on the blockchain network.",
		point2: "The balance, which is the amount of cryptocurrency or tokens that the user owns in their wallet.",
		point3: "The transaction history, which is a record of all the incoming and outgoing transactions that the user has made with their wallet.",
		point4: "The token holdings, which are the different types of tokens that the user has in their wallet, such as ERC-20 tokens, NFTs, etc.",
		point5: "The DeFi activities, which are the different types of DeFi services or protocols that the user has interacted with using their wallet, such as lending, borrowing, staking, swapping, etc."
	},
	{
		heading: "Why would I want to search any user’s DeFi wallet?",
		content: "There are many reasons why you might want to search any user’s DeFi wallet, such as:",
		point1: "To verify the authenticity or legitimacy of a user or a project that claims to have a certain amount of funds or tokens in their wallet.",
		point2: "To monitor the performance or behaviour of a user or a project that you are interested in or invested in.",
		point3: "To learn from the strategies or patterns of a user or a project that is successful or influential in the DeFi space.",
		point4: "To discover new opportunities or trends in the DeFi space by analysing the data or insights from different users or projects.",
	}
];
...
export const DeFi = [
	...
	},
	{
		...
		content: "DeFi also comes with risks, such as:",
		point1: "Smart Contract Bugs: Flaws in code can lead to vulnerabilities and potential loss of funds.",
		point2: "Impermanent Loss: Users providing liquidity to DeFi pools might experience losses due to price fluctuations.",
		point3: "Regulatory Uncertainty: DeFi regulations are evolving and can impact the legality of certain activities.",
		point4: "Hacks and Exploits: DeFi platforms can be vulnerable to hacks and security breaches."
	},
	{
